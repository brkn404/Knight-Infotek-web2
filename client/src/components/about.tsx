          ...
          <div className="grid md:grid-cols-2 gap-16 items-start mb-16">
            <div className="bg-card/50 rounded-xl p-8 border border-white/10">
              <h3 className="text-2xl font-bold font-display mb-6 text-white flex items-center gap-3">
                <Globe className="w-6 h-6 text-primary" /> Knight InfoTek Global (Ireland)
              </h3>
            ...
            <div className="bg-card/50 rounded-xl p-8 border border-white/10">
              ...
              <ul className="space-y-4 text-muted-foreground">
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                  <span><strong className="text-white">Implements and operationalizes Knight InfoTek Global technology</strong></span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
          ...
          <div className="mt-16 mb-16">
            <div className="bg-card/50 rounded-xl p-8 md:p-12 border border-white/10">
              <div className="text-center mb-8">
                ...
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                  Knight InfoTek Global invents the technology. Others license or acquire it to build their own companies.
                </p>
              </div>
              ...
              <Card className="bg-background/50 border-white/10">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    <strong>Identity through behavior. Integrity through provenance. Trust through continuous verification.</strong> Knight InfoTek Global delivers a unified behavioral trust platform powered by GenomeX.
                  </p>
                </CardContent>
              </Card>
