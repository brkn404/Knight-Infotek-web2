...
export function Services() {
  const services = [
    ...
    },
    {
      ...
      description: "We help organizations seamlessly absorb Knight InfoTek Global-developed technologies into their own teams — with or without internal engineering.",
      link: "#contact"
    },
    {
      icon: Users,
